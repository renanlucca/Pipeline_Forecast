...
if uploaded_file:
    ...
    required_cols = ["Deal Name", "Deal Value", "Current Stage", "Forecast Action", "Expected Close Date"]
    if not all(col in df.columns for col in required_cols):
        st.error("❌ CSV must include: Deal Name, Deal Value, Current Stage, Forecast Action, Expected Close Date")
    else:
        # Clean data
